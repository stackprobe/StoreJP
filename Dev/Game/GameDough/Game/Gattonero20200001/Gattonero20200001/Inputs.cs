...
namespace Charlotte
{
	public static class Inputs
	{
		...
		public static Input D = new Input(DX.KEY_INPUT_V, 8, "拡張ボタン２");
		public static Input E = new Input(DX.KEY_INPUT_A, 6, "拡張ボタン３");
		public static Input F = new Input(DX.KEY_INPUT_S, 9, "拡張ボタン４");
		public static Input L = new Input(DX.KEY_INPUT_D, 10, "拡張ボタン５");
		public static Input R = new Input(DX.KEY_INPUT_F, 11, "拡張ボタン６");
