...
namespace Charlotte.Games.SActions
{
	public static class SAConsts
	{
		...
		/// プレイヤーキャラクタの重力加速度
		/// </summary>
		public const double PLAYER_GRAVITY = 0.4;
		...
		/// プレイヤーキャラクタのジャンプ初速度
		/// </summary>
		public const double PLAYER_JUMP_SPEED = -12.0;
		...
		public const double PLAYER_側面判定Pt_YT = 16.0;
		public const double PLAYER_側面判定Pt_YB = 16.0;
		public const double PLAYER_脳天判定Pt_X = 9.0;
		public const double PLAYER_脳天判定Pt_Y = 32.0;
		public const double PLAYER_接地判定Pt_X = 9.0;
		public const double PLAYER_接地判定Pt_Y = 32.0;
	}
}
