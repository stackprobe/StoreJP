...
namespace Charlotte.Games.SActions.Attacks
{
	...
	public static class SAAttackCommon
	{
		...
		{
			bool touchSide_L =
				SAGame.I.Field.IsWall(SACommon.ToTablePoint(new D2Point(SAGame.I.Player.X - SAConsts.PLAYER_側面判定Pt_X, SAGame.I.Player.Y - SAConsts.PLAYER_側面判定Pt_YT))) ||
				SAGame.I.Field.IsWall(SACommon.ToTablePoint(new D2Point(SAGame.I.Player.X - SAConsts.PLAYER_側面判定Pt_X, SAGame.I.Player.Y))) ||
				SAGame.I.Field.IsWall(SACommon.ToTablePoint(new D2Point(SAGame.I.Player.X - SAConsts.PLAYER_側面判定Pt_X, SAGame.I.Player.Y + SAConsts.PLAYER_側面判定Pt_YB)));
		...
		{
			bool touchCeiling_L =
				SAGame.I.Field.IsWall(SACommon.ToTablePoint(new D2Point(SAGame.I.Player.X - SAConsts.PLAYER_脳天判定Pt_X, SAGame.I.Player.Y - SAConsts.PLAYER_脳天判定Pt_Y)));

			bool touchCeiling_M =
				SAGame.I.Field.IsWall(SACommon.ToTablePoint(new D2Point(SAGame.I.Player.X, SAGame.I.Player.Y - SAConsts.PLAYER_脳天判定Pt_Y)));
		...
		{
			bool touchGround =
				SAGame.I.Field.IsWall(SACommon.ToTablePoint(new D2Point(SAGame.I.Player.X - SAConsts.PLAYER_接地判定Pt_X, SAGame.I.Player.Y + SAConsts.PLAYER_接地判定Pt_Y))) ||
				SAGame.I.Field.IsWall(SACommon.ToTablePoint(new D2Point(SAGame.I.Player.X + SAConsts.PLAYER_接地判定Pt_X, SAGame.I.Player.Y + SAConsts.PLAYER_接地判定Pt_Y)));
