...
namespace Charlotte.Games.SActions
{
	public static class SAConsts
	{
		...
		/// プレイヤーキャラクタの重力加速度
		/// </summary>
		public const double PLAYER_GRAVITY = 0.5;
		...
		/// プレイヤーキャラクタのジャンプ初速度
		/// </summary>
		public const double PLAYER_JUMP_SPEED = -11.0;
		...
		public const double PLAYER_側面判定Pt_X = 11.0;
		public const double PLAYER_側面判定Pt_YT = 4.0;
		public const double PLAYER_側面判定Pt_YB = 19.0;
		public const double PLAYER_脳天判定Pt_X = 10.0;
		public const double PLAYER_脳天判定Pt_Y = 16.0;
		public const double PLAYER_接地判定Pt_X = 10.0;
		public const double PLAYER_接地判定Pt_Y = 30.0;
	}
}
