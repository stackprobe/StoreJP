...
namespace Charlotte
{
	public static class Inputs
	{
		...
		public static Input C = new Input(DX.KEY_INPUT_C, 5, "武器選択・進む");
		public static Input D = new Input(DX.KEY_INPUT_V, 8, "武器選択・戻る");
		public static Input E = new Input(DX.KEY_INPUT_A, 6, "拡張ボタンＥ");
		public static Input F = new Input(DX.KEY_INPUT_S, 9, "拡張ボタンＦ");
