...
namespace Charlotte
{
	public static class Pictures
	{
		...
		{
			{
				new Picture(@"Picture\点睛集積\チルノ\thv8_cirno2_0000.png"),
				new Picture(@"Picture\点睛集積\チルノ\thv8_cirno2_0001.png"),
				new Picture(@"Picture\点睛集積\チルノ\thv8_cirno2_0002.png"),
				new Picture(@"Picture\点睛集積\チルノ\thv8_cirno2_0003.png"),
			},
			{
				new Picture(@"Picture\点睛集積\チルノ\thv8_cirno2_0100.png"),
				new Picture(@"Picture\点睛集積\チルノ\thv8_cirno2_0101.png"),
				new Picture(@"Picture\点睛集積\チルノ\thv8_cirno2_0102.png"),
				new Picture(@"Picture\点睛集積\チルノ\thv8_cirno2_0103.png"),
			},
			{
				new Picture(@"Picture\点睛集積\チルノ\thv8_cirno2_0200.png"),
				new Picture(@"Picture\点睛集積\チルノ\thv8_cirno2_0201.png"),
				new Picture(@"Picture\点睛集積\チルノ\thv8_cirno2_0202.png"),
				new Picture(@"Picture\点睛集積\チルノ\thv8_cirno2_0203.png"),
			},
			{
				new Picture(@"Picture\点睛集積\チルノ\thv8_cirno2_0300.png"),
				new Picture(@"Picture\点睛集積\チルノ\thv8_cirno2_0301.png"),
				new Picture(@"Picture\点睛集積\チルノ\thv8_cirno2_0302.png"),
				new Picture(@"Picture\点睛集積\チルノ\thv8_cirno2_0303.png"),
			},
			{
				new Picture(@"Picture\点睛集積\チルノ\thv8_cirno2_0400.png"),
				new Picture(@"Picture\点睛集積\チルノ\thv8_cirno2_0401.png"),
				new Picture(@"Picture\点睛集積\チルノ\thv8_cirno2_0402.png"),
				new Picture(@"Picture\点睛集積\チルノ\thv8_cirno2_0403.png"),
			},
			{
				new Picture(@"Picture\点睛集積\チルノ\thv8_cirno2_0500.png"),
				new Picture(@"Picture\点睛集積\チルノ\thv8_cirno2_0501.png"),
				new Picture(@"Picture\点睛集積\チルノ\thv8_cirno2_0502.png"),
				new Picture(@"Picture\点睛集積\チルノ\thv8_cirno2_0503.png"),
			},
		};
